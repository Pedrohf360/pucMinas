...
namespace _2017_10_31_BolhaInsercao
{
    public partial class Merge : Form
    {
        ...
        public Merge(double tempoMinimo, double tempoMedio, double tempoMaximo, long quantComp, int tamanhoVetor, string nomeArq, string tipoVetOrd)
        {
            InitializeComponent();
