...
namespace _2017_10_31_BolhaInsercao
{
    public partial class Insercao : Form
    {
        ...
        public Insercao(double tempoMinimo, double tempoMedio, double tempoMaximo, long quantComp, int tamanhoVetor, string nomeArq, string tipoVetOrd)
        {
            InitializeComponent();
        ...
        public Insercao(string nomeArq)
        {
            InitializeComponent();
